#ifndef _HIPSMITH_HIPVARIABLE_H_
#define _HIPSMITH_HIPVARIABLE_H_
 ...
 ***/
void GetVarsFromExpr(std::set<const Variable*>* expr_vars,
 ...
 ***/
void RecordMultipleVars(std::set<const Variable*>* accesses,
...
#endif  //  _HIPSMITH_HIPVARIABLE_H_